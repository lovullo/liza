...
exports.between = create('between', {
  ...
  assert: function () {
    ...
    return this.given < lower || this.given > upper ? false : true;
  },
});
...
exports.greaterThan = create('greaterThan', function () {
  return +this.given > +this.expected ? true : false;
});
...
exports.notEmpty = create('notEmpty', function () {
  ...
  return !exports.empty.assertSingle(this.expected, this.given);
});
