...
module.exports = Class('DateValidator', {
  ...
  'private _getMonthId': function (name) {
    ...
    var month = new Date('1 ' + name + ' 2000').getMonth() + 1;
  ...
  'private _normalizeDate': function (match, p1, p1_str, p2, p2_str, p3) {
    ...
    if (year < 100) {
      ...
      year = year < cutoff ? '20' + padding + year : '19' + padding + year;
    }

    this._validateMonthDay(month, day, new Date(year, 1, 29).getMonth() == 1);
