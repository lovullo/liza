    ...
    .extend( EventEmitter,
{
    ...
    _initStaticContent: function()
    {
        ...
        this.$content.find( '#sidebar_static_content' ).html( this.data.static_content );
    },
    ...
    {
        this.$content.find( '#quoteid' ).text(
            this.__self.$('_QUOTE_ID_PREFIX') + id
        );
