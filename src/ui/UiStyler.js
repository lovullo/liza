 ...
 */
module.exports = Class('UiStyler').extend(EventEmitter, {
  /**
   * EventEmitter events
   *
  ...
  'public register': function (as) {
    ...
    return function () {
      ...
      _self.emit.apply(
        _self,
        [as, _self._context].concat(Array.prototype.slice.call(arguments))
      );
    };
  ...
  'private _initQuestionHover': function () {
    var _self = this;
    this._$content.live('mouseover.program mouseout.program', function (event) {
  ...
  'private _initQuestionFocus': function () {
    ...
    this._$content
      .find('input')
      .live('focus.program, blur.program', function (event) {
        var hl =
          event.type == 'focus' || event.type == 'focusin' ? true : false;
  ...
  'private _initErrorBoxHover': function () {
    ...
    this._$content
      .find('.error-box li')
      .live('mouseover.program mouseout.program', function (event) {
        var $this = $(this);
        var name = $this.data('ref');
        var index = $this.data('ref_index');

        var $element = _self._$content
          .find('[name="' + name + '[]"]:nth(' + index + ')')
          .parents('tr, dd');
