...
module.exports = Class('DomField')
  ...
  .extend(EventEmitter, {
    ...
    'protected resolveId': function () {
      return this.doResolveId(this._field.getName(), this._field.getIndex());
    },
    ...
    'protected getContainingRow': function () {
      ...
      return dt ? [dd, dt] : [this.getParent()];
    },
    ...
    'protected getSibling': function (element, type, direction) {
      ...
      var next = element[direction === -1 ? 'previousSibling' : 'nextSibling'];
      if (next === null) {
        return null;
      }
