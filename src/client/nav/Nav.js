...
module.exports = Class('Nav').extend(EventEmitter, {
  ...
  getNextStepId: function () {
    return this.hasNextStep() ? this._lastStepId + 1 : this._lastStepId;
  },
  ...
  getPrevStepId: function () {
    return this.hasPrevStep() ? this._lastStepId - 1 : this._lastStepId;
  },
  ...
  isValidNextStep: function (step_id) {
    return step_id > this.getTopVisitedStepId() + 1 ? false : true;
  },
