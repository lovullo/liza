...
/* eslint no-var: "off", no-unused-vars: "off", prefer-arrow-callback: "off", no-undef: "off" */
/**
      ...
      return ($div = $('<div>')
        .append(
          $('<button>')
            ...
            .toggle(
              function () {
                $('#content').append(_self._$list.addClass('dock').detach());
              },
              function () {
                $div.append(_self._$list.removeClass('dock').detach());
              }
            )
        )
        .append(this._$list));
