...
describe('FieldContext', () => {
  ...
  [
    ...
    {
      label:
        'setOptions sets previous value when new value is not provided and old value still exists',
      options: [
    ...
    {
      label:
        'setOptions sets default value when requested value is not an option',
      options: [
    ...
    {
      label:
        'setOptions sets default value when new value is not provided and old value no longer exists',
      options: [
        {value: '', label: 'I am the default', label_id: 'foo_label'},
    ...
    ({
      ...
      it(label, () => {
        const group_content = getGroupContent();
        const content = group_content.querySelector(
          '#qcontainer_select_element'
        );
        ...
        const selected_option = <HTMLSelectElement>(
          final_content.querySelector('#q_select_element_0')
        );
