    ...
    [
        {
            ...
            html_content: '<span data-field-name="foo" id="foo_dca320"' +
    ...
    [
        {
            ...
            expected_html: '<dd><span data-field-name="foo" id="foo_dca320"' +
        ...
        it ( label, () =>
        {
            ...
            const element = content.querySelector( '[data-field-name="' + field_name + '"]' );
