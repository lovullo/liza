...
import {
  ...
  GroupList,
} from '../../../src/ui/step/GridCollection';
...
describe('ui.step.GridCollection', () => {
  describe('visit', () => {
    ...
    [
      ...
      let {columns, input, expected_class_added, expected_class_removed} = data;
  ...
  describe('handleClick', () => {
    ...
    it('step lock disables click', () => {
      let expected = ['closeDetails grid group 0', 'closeDetails grid group 1'];
...
const createCollectionMarkup = () => {
  ...
  collection.innerHTML = `<fieldset class="grid" id="group_grid0">
            <div id="grid0">
